...
var constants = module.exports = {
  ...
  messageKindFromString: function (messageKind) {
    if (messageKind === constants.MessageKind.Text.key) {
      return constants.MessageKind.Text.value
    } else if (messageKind === constants.MessageKind.Media.value) {
      return constants.MessageKind.Media.value
    } else if (messageKind === constants.MessageKind.DiscoverShared.value) {
